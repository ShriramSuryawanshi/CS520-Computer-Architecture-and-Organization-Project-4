...
/**
 * As a design choice, some data elements that are accessed by multiple pipeline
 * stages are stored in a common object.
 *
 * @author
 */
public class GlobalData extends PropertiesContainer implements IGlobals {
    ...
    public void setup() {
        ...
        // @shree -  making ti  of 256, marking physical
